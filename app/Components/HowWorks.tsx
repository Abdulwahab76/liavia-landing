...
const app: ProductSection = {
  ...
  steps: [
    {
      duration: "1",
      title: "LiaVia calibrated and downloaded",
      subtitle: "for your organisation",
    },
    {
      duration: "2",
      title: "Communication data ingested",
      subtitle: "pattern analysis with anonymisation",
    },
    {
      duration: "3",
      title: "Insights and risk detection",
      subtitle: "delivered to nominated leaders",
    },
  ],
};
...
function Timeline({ steps, title }: { steps: ProcessStep[]; title: string }) {
  return (
    <div className="mt-5">
      ...
      <p className="text-lg  font-bold mb-3" style={{ color: "#3d3b2e" }}>
        {title}
      </p>
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <h5 className="text-xl font-bold" style={{ color: "#1e1d18" }}>
          {product.tag}
        </h5>
      </div>
